...
<body>
	...
	<div id="continue">
		...
		<div class="or">OR</div>
		<a id="fb-connect" href="/oauth_fb" class="login-btn"></a><br clear="all">
	</div>
	...
	<div class="blockShadow" id="prediction" >
		<div class="predPart" align="center">
			<div class="winsTT">
				...
				<span class="pers">(<?php echo $team1->percent ?>)</span>
			</div>
			<div class="Users">
				...
				<img src="https://graph.facebook.com/moh97/picture" width="30" height="30" />
				<img src="https://graph.facebook.com/moh97/picture" width="30" height="30" />
				<img src="https://graph.facebook.com/moh97/picture" width="30" height="30" /><br clear="all">
				<div class="maxPred">
					<span>2 - 1</span>
					<div class="progress">
						<span class="complete" style="width:90%"></span>
					</div>
					<span>100</span>
				</div>
				<div class="maxPred">
					<span>2 - 1</span>
					<div class="progress">
						<span class="complete" style="width:80%"></span>
					</div>
					<span>100</span>
				</div>
				<div class="maxPred">
					<span>2 - 1</span>
					<div class="progress">
						<span class="complete" style="width:70%"></span>
					</div>
					<span>100</span>
				</div>
				<div class="maxPred">
					<span>2 - 1</span>
					<div class="progress">
						<span class="complete" style="width:60%"></span>
					</div>
					<span>100</span>
				</div>
				<div class="maxPred">
					<span>2 - 1</span>
					<div class="progress">
						<span class="complete" style="width:20%"></span>
					</div>
					<span>100</span>
				</div>
			</div>
		...
		<div class="predPart equal" align="center">
			<span class="topTitle">Recent predictions</span>
			<span class="sayth">Equalizer</span>
			<span class="pers">(40%)</span>
			<div class="Users">
				<img src="https://graph.facebook.com/moh97/picture" width="30" height="30" />
				<img src="https://graph.facebook.com/moh97/picture" width="30" height="30" />
				<img src="https://graph.facebook.com/moh97/picture" width="30" height="30" />
		...
		<div class="predPart last" align="center">
			<div class="winsTT">
				...
				<span class="pers">(<?php echo $team2->percent ?>)</span>
			</div>
			<div class="Users">
				<img src="https://graph.facebook.com/moh97/picture" width="30" height="30" />
				<img src="https://graph.facebook.com/moh97/picture" width="30" height="30" />
		...
		<br clear="all">
		<div class="fb-comments" data-href="http://www.datrios.com/matches/<?php echo $match->id ?>" data-num-posts="5" data-width="598" style="margin-left:1px; border-top:2px #CCC solid; margin-top:10px;"></div>
	</div><!--prediction-->
